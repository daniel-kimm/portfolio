      ...
      <div className="flex flex-col px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 pt-20 sm:pt-24 md:pt-28 lg:pt-12 pb-16 w-full min-h-screen">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="text-left text-white text-lg leading-relaxed mb-4" style={{ fontFamily: "'IM Fell Great Primer', serif" }}>
            <p className="mb-1">
              This is a scouting app for FIRST Robotics Competition.
              Currently used by RoboWhales, a 40-member FRC robotics team, this app features a RAG-based chatbot with OpenAI API integration for match analysis and strategy recommendations.
              I also developed an analytics dashboard using Chart.js visualizations for real-time competition data processing.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-3 justify-center mb-8">
            {['JavaScript', 'React', 'RAG', 'Express', 'Firebase', 'Chart.js', 'OpenAI API'].map((tech) => (
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-8">
            <div className="w-full md:w-1/2">
              <Image 
                src="/9032scout/9032scoutassistant.png" 
                alt="Detailed Stats" 
                width={800}
                height={600}
          ...
          {/* Single image on bottom - Scout Assistant */}
          <div className="mb-8 max-w-[50%] mx-auto">
            <Image 
              src="/9032scout/detailedstats.png" 
              alt="9032 Scout Assistant" 
              width={800}
              height={600}
              className="w-full rounded-lg border border-white/30"
              placeholder="blur"
