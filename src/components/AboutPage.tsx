        ...
        <div className="relative px-8 sm:px-12 md:px-16 py-8 sm:py-10 md:py-12">
          ...
          >
            ...
            <ul className="list-disc list-inside ml-2 sm:ml-4 mb-4 sm:mb-6 space-y-1">
              <li>Software Development Engineer Intern at <a href="https://aws.amazon.com/ec2/?p=ft&c=cp&z=3&refid=f6a12ba8-7847-4dfb-90ab-7e757d2f0f56" target="_blank" rel="noopener noreferrer" className="text-emerald-800 underline hover:text-emerald-600 transition-colors duration-300">AWS EC2</a> Edge Frontier</li>
